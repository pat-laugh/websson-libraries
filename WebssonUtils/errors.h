...
namespace webss
{
	...
	const std::string ERROR_UNEXPECTEDs1("unexpected character: '");
	const std::string ERROR_EXPECTED_CHARs1("expected character '");
	const std::string STRING_SINGLE_QUOTE("'");
#define webss_ERROR_UNEXPECTED ERROR_UNEXPECTEDs1 + *it + STRING_SINGLE_QUOTE
...
#define webss_ERROR_VARIABLE_EXISTS(name) ERROR_VARIABLE_EXISTSs1 + name
	...
	const char ERROR_ANONYMOUS_KEY[] = "can't have anonymous key in dictionary, function head, namespace or enum";
