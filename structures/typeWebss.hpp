...
namespace webss
{
	...
	public:
		enum class Enum
		{
			...
			TEMPLATE_HEAD, TEMPLATE_HEAD_BINARY, TEMPLATE_HEAD_SELF, TEMPLATE_HEAD_STANDARD, TEMPLATE_HEAD_TEXT,
			TEMPLATE_BINARY, TEMPLATE_STANDARD, TEMPLATE_TEXT,
			TEMPLATE_HEAD_PLUS_BINARY, TEMPLATE_HEAD_PLUS_STANDARD, TEMPLATE_HEAD_PLUS_TEXT,
			TEMPLATE_PLUS_BINARY, TEMPLATE_PLUS_STANDARD, TEMPLATE_PLUS_TEXT,
		...
		static const Enum NONE = Enum::NONE, ENTITY = Enum::ENTITY, DEFAULT = Enum::DEFAULT,
			...
			TEMPLATE_HEAD = Enum::TEMPLATE_HEAD, TEMPLATE_HEAD_BINARY = Enum::TEMPLATE_HEAD_BINARY, TEMPLATE_HEAD_SELF = Enum::TEMPLATE_HEAD_SELF, TEMPLATE_HEAD_STANDARD = Enum::TEMPLATE_HEAD_STANDARD, TEMPLATE_HEAD_TEXT = Enum::TEMPLATE_HEAD_TEXT,
			TEMPLATE_BINARY = Enum::TEMPLATE_BINARY, TEMPLATE_STANDARD = Enum::TEMPLATE_STANDARD, TEMPLATE_TEXT = Enum::TEMPLATE_TEXT,
			TEMPLATE_HEAD_PLUS_BINARY = Enum::TEMPLATE_HEAD_PLUS_BINARY, TEMPLATE_HEAD_PLUS_STANDARD = Enum::TEMPLATE_HEAD_PLUS_STANDARD, TEMPLATE_HEAD_PLUS_TEXT = Enum::TEMPLATE_HEAD_PLUS_TEXT,
			TEMPLATE_PLUS_BINARY = Enum::TEMPLATE_PLUS_BINARY, TEMPLATE_PLUS_STANDARD = Enum::TEMPLATE_PLUS_STANDARD, TEMPLATE_PLUS_TEXT = Enum::TEMPLATE_PLUS_TEXT,
