...
namespace webss
{
	...
	public:
		enum class Enum
		{
			...
			TEMPLATE_VALUE_HEAD_BINARY, TEMPLATE_VALUE_HEAD_STANDARD, TEMPLATE_VALUE_HEAD_TEXT,
			TEMPLATE_VALUE_BINARY, TEMPLATE_VALUE_STANDARD, TEMPLATE_VALUE_TEXT,
		...
		static const Enum NONE = Enum::NONE, ENTITY = Enum::ENTITY, DEFAULT = Enum::DEFAULT,
			...
			TEMPLATE_VALUE_HEAD_BINARY = Enum::TEMPLATE_VALUE_HEAD_BINARY, TEMPLATE_VALUE_HEAD_STANDARD = Enum::TEMPLATE_VALUE_HEAD_STANDARD, TEMPLATE_VALUE_HEAD_TEXT = Enum::TEMPLATE_VALUE_HEAD_TEXT,
			TEMPLATE_VALUE_BINARY = Enum::TEMPLATE_VALUE_BINARY, TEMPLATE_VALUE_STANDARD = Enum::TEMPLATE_VALUE_STANDARD, TEMPLATE_VALUE_TEXT = Enum::TEMPLATE_VALUE_TEXT,
