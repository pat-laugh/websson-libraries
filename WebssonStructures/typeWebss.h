...
namespace webss
{
	...
	public:
		enum class Enum
		{
			...
			FUNCTION_HEAD_BINARY, FUNCTION_HEAD_SCOPED, FUNCTION_HEAD_STANDARD, FUNCTION_HEAD_TEXT,
		...
		static const Enum NONE = Enum::NONE, ENTITY = Enum::ENTITY, DEFAULT = Enum::DEFAULT,
			...
			FUNCTION_HEAD_BINARY = Enum::FUNCTION_HEAD_BINARY, FUNCTION_HEAD_SCOPED = Enum::FUNCTION_HEAD_SCOPED, FUNCTION_HEAD_STANDARD = Enum::FUNCTION_HEAD_STANDARD, FUNCTION_HEAD_TEXT = Enum::FUNCTION_HEAD_TEXT,
