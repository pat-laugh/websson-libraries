...
namespace webss
{
	...
	public:
		enum class Enum
		{
			...
			BINARY, MANDATORY,
			DOCUMENT, BLOCK_VALUE, BLOCK_ID, NAMESPACE, ENUM
		};
		static const Enum NONE = Enum::NONE, VARIABLE = Enum::VARIABLE, DEFAULT = Enum::DEFAULT,
			...
			DOCUMENT = Enum::DOCUMENT, BLOCK_VALUE = Enum::BLOCK_VALUE, BLOCK_ID = Enum::BLOCK_ID, NAMESPACE = Enum::NAMESPACE, ENUM = Enum::ENUM;
