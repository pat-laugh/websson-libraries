...
const std::string schemaFeature[] = { "type", "features" };
const std::string schemaFeatures[] = { "type", "geometry", "properties" };
const std::string schemaGeometry[] = { "type", "coordinates" };
const std::string schemaProperties[] = { "name", "description", "date", "timeStart", "timeEnd", "area", "truckName", "truckId" };
const std::string schemaDate[] = { "year", "month", "day" };
const std::string schemaTime[] = { "hours", "mins" };
